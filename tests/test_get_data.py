...
class GetDataTestCls(unittest.TestCase):
    def test_get_int_data(self):
       db.get_data("tbl_employees", json_data={"id": 1 })
       self.assertEqual(True, False)  # add assertion here

    def test_get_str_data(self):
       data =  {'id': '1', 'empname': 'EMP_1', 'emploc': 'UAE', 'empsal': '15000.0',
         ...
         'Lastdate': 'None'}
       status = db.get_data("tbl_employees", json_data={"id":9989627, 'empname': 'EMP_998967'})
    ...
    def test_get_json_data(self):
       ...
       get_data["id"] = 123
       status = db.get_data("tbl_employees", json_data=get_data)
       self.assertEqual(True, status)  # add assertion here

    def test_get_datetime_data(self):
    ...
    def test_get_wrong_datatype_null_data_exception(self):
       # 'dateofjoin': '2022-11-17 00:00:00', 'Lastdate': 'None'
       get_data = {}
       get_data["Lastdate"] = 'None'
       get_data["id"] = 123
    ...
    def test_get_wrong_data_for_float_datatype_field_exception(self):
       # 'dateofjoin': '2022-11-17 00:00:00', 'Lastdate': 'None'
       get_data = {}
    ...
    def test_get_Data_with_all_columns(self):
       # 'dateofjoin': '2022-11-17 00:00:00', 'Lastdate': 'None'
       get_data = {'id': 11121012, 'empname': 'EMP_1', 'emploc': 'UAE', 'empsal': 15000.0,
